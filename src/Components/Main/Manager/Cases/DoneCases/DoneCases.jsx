...
const Main = () => {
    ...
    const doneCases = cases.filter((cas)=>cas.status===DONE_STATUS)
    ...
    const filteredCases = doneCases.filter(cas => {
    ...
    return (
        <main className={style.main}>
            ...
            <div className={certificateStyle.certificate}>
                <a href={links.finished_cases} target="_blank">About this page</a>
