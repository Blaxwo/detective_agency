...
const Main = () => {
    ...
    const canceledCases = useSelector(state => state.casesPage.canceledCases);
    ...
    const filteredCases = canceledCases.filter(cas => {
    ...
    return (
        <main className={style.main}>
            ...
            <div className={certificateStyle.certificate}>
                <a href={links.canceled_cases} target="_blank">About this page</a>
