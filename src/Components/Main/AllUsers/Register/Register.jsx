...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            dispatch(addNewClient({ id: usersCount, role: "client", name: user, mail: email, age: age, password: pwd, description: "New user, there is no description now", workplace: "Unknown", Paid: "No"}));
            setUser('');
            setEmail('');
            setAge('');
            setPwd('');
